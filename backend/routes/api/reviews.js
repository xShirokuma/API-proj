...
router.get("/current", requireAuth, async (req, res, next) => {
  ...
  for (const review of reviews) {
    ...
    if (previewImg) reviewJson.Spot.previewImage = previewImg.url;
    else reviewJson.Spot.previewImage = null;
...
router.put("/:id", requireAuth, validateReview, async (req, res, next) => {
  ...
  if (review) reviewEdit.review = review;
  if (stars) reviewEdit.stars = stars;
